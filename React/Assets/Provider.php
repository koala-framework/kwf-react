    ...
    public function getDependency($dependencyName)
    {
        if (substr($dependencyName, 0, 4) == 'kwf/') {
            ...
            if (file_exists(KWF_PATH.'/commonjs/'.$dependencyName.'.jsx')) {
                ...
                return $ret;
            } else if (file_exists(KWF_PATH.'/commonjs/'.$dependencyName.'/index.jsx')) {
                $ret = new React_Assets_Dependency_File_Jsx($this->_providerList, 'kwf/commonjs/'.$dependencyName.'/index.jsx');
                return $ret;
            }
            ...
            if (file_exists('./'.$dependencyName.'.jsx')) {
                ...
                return $ret;
            } else if (file_exists('./'.$dependencyName.'/index.jsx')) {
                $ret = new React_Assets_Dependency_File_Jsx($this->_providerList, 'web/'.$dependencyName.'/index.jsx');
                return $ret;
            }
        }
        return null;
